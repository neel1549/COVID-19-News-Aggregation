      ...
      <div>
        <div className="container">
          <div className="row">
            ...
            >
              <Dropdown.Item onClick={this.filterSelect}>All</Dropdown.Item>
              <Dropdown.Item onClick={this.filterSelect}>Dine-In</Dropdown.Item>
              <Dropdown.Item onClick={this.filterSelect}>
                Take-out
              </Dropdown.Item>
              <Dropdown.Item onClick={this.filterSelect}>
                Delivery
